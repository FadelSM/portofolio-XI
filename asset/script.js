...
function initThanksSection() {
  ...
  // Thanks data
  const thanksData = [
    { name: 'Ibu Afrinawati, M.Pd', relation: 'homeroom teacher', icon: 'fas fa-chalkboard-teacher' }
  ];
...
// Thanks Section
function initThanks1Section() {
  const thanksGrid1 = document.querySelector('.thanks-grid1');
  
  // Thanks data
  const thanksData1 = [
    { name: 'Akhtar Jaya Wardhana', relation: 'Laki-Laki', icon: 'fas fa-user-shield' },
    { name: 'Azhar Aziz Hamdani', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Bagus Raditya Faturrahman', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Damar Cahyo Panuluh', relation: 'Laki-Laki', icon: 'fas fa-broom' },
    { name: 'Dewi Thoatika Nurjanah', relation: 'Perempuan', icon: 'fas fa-pen-alt' },
    { name: 'Eka Puspita Novita Damayanti', relation: 'Perempuan', icon: 'fas fa-wallet' },
    { name: 'Evan Al Rasyid', relation: 'Laki-Laki', icon: 'fa fa-handshake' },
    { name: 'Fadel Shafwan Maliki', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Faqih Arya Pasha', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Fazril Ilyas', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Firdaus Ilham', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Fitri Lailan Najmi', relation: 'Perempuan', icon: 'fas fa-file-signature' },
    { name: 'Intan Aliyana', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Jenius Hosevan Simon Panjaitan', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Juwita Apriyani', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Kayla Khalidah Tajudin', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Keyla Nur Hasanah', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Khoirul Anisa Putri', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Lequinsha Zalyandra Bilqis', relation: 'Perempuan', icon: 'fas fa-user-friends' },
    { name: 'Lintang Azzalea Pratama', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Lutfiah Thalita Azmi', relation: 'Perempuan', icon: 'fas fa-coins' },
    { name: 'Miftah Khoiron Ramadhan', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Moura Dealova Kanza Adiba T.', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Muhammad Rizky Maulana', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Muhammad Adelio Faustin AB', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Nabilla Oktavia Andini', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Nova Zaidah', relation: 'Perempuan', icon: 'fas fa-award' },
    { name: 'Poros Baroki Bumas', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Rayiandra Abinaya', relation: 'Laki-Laki', icon: 'fas fa-user-lock' },
    { name: 'Rizqi Khoiril Ibad', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Steven Febrian Pratama', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Zafir Raihan Basri', relation: 'Laki-Laki', icon: 'fas fa-handshake' },
    { name: 'Zalfa Zahirah', relation: 'Perempuan', icon: 'fas fa-award' },
  ];
  
  // Generate thanks cards
  thanksData1.forEach(person => {
    const card = document.createElement('div');
    card.className = 'thanks-card';
